// SocialLinks.jsx — Pega este archivo en src/components/
// Úsalo en LawyerCard así:
//   import SocialLinks from './SocialLinks'
//   <SocialLinks profile={lawyer} />
...
export default function SocialLinks({ profile, size = 'md' }) {
  const links = NETWORKS.filter(n => profile?.[n.key])

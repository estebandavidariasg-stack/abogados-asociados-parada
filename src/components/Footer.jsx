    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.contact}>
          ...
          <a href="mailto:contacto@aapabogados.co" className={styles.contactItem}>
            <span className={styles.contactIcon}><IconMail /></span>
            <div>
              <span className={styles.contactLabel}>En cualquier momento</span>
              <span className={styles.contactValue}>contacto@aapabogados.co</span>
              <span className={styles.contactSub}>Respondemos en menos de 24 horas</span>
            </div>
          </a>
          <a href="https://wa.me/573001234567" target="_blank" rel="noopener noreferrer" className={styles.contactItem}>
            <span className={styles.contactIcon}><IconPhone /></span>
            <div>
              <span className={styles.contactLabel}>¿Tienes dudas?</span>
              <span className={styles.contactValue}>Contáctanos por WhatsApp</span>
            </div>
          </a>
        </div>

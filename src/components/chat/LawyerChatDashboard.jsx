    ...
    <div ref={dashRef} className={`${styles.dashboard} ${activeRoom ? styles.dashboardChatOpen : ''}`}>
          ...
          <>
            ...
            {activeRoom.status !== 'closed' && (
                <div className={styles.headerActions}>
                  ...
                  {!pagoConfirmado && (verifiedRooms.has(activeRoom.id)
                  ...
                  {/* Cobro de asesoría (manual, cliente → profesional) */}
                  {!pagoConfirmado && (cobro?.estado === 'pendiente' && cobro?.marcado_cliente_at ? (
                    <>
                      {cobro?.comprobante_path && (
                        ...
                        >
                          <IconPaperclip size={14} /> Comprobante del cliente
                        </button>
                      )}
                      <button
                        type="button"
      ...
      {cobroOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="modalCobroTitle"
        >
          <div className={styles.modalCard} onClick={e => e.stopPropagation()}
